...
import com.example.downloaderlib.downloaderlib2.getErrorFromMessage
import com.example.downloaderlib.downloaderlib2.fetch.FetchModulesBuilder.Modules
import com.example.downloaderlib.downloaderlib2.util.ActiveDownloadInfo
import com.example.downloaderlib.downloaderlib2.util.DEFAULT_ENABLE_LISTENER_AUTOSTART_ON_ATTACHED
import com.example.downloaderlib.downloaderlib2.util.DEFAULT_ENABLE_LISTENER_NOTIFY_ON_ATTACHED
import com.example.downloaderlib.downloaderlib2.util.toDownloadInfo
...
open class FetchImpl constructor(override val namespace: String,
    ...
    override fun awaitFinishOrTimeout(allowTimeInMilliseconds: Long) {
        com.example.downloaderlib.downloaderlib2.util.awaitFinishOrTimeout(allowTimeInMilliseconds, fetchHandler)
    }
